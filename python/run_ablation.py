...
d = 'run_07_10_26_all_neighbors' # out directory
...
# Build the model to match the pre-trained architecture from the run_analysis.py script
# Probably a better way to actually save all the parameters and load them in
...
# Skip training and just load pretrained model weights
trainer.model.load_state_dict(torch.load(f'{dst_dir}/model.pt', weights_only = True))

# Build the ablation model and calculate scores
